...
!(function (e, t) {
  ...
  const x =
      ...
      if ('string' == typeof p && U.test(p) && ((n = p), x))
        try {
          let e = new URL(window.location.href),
            ...
            n = o.stripBasename(t.pathname, y);
    ...
    T = i.forwardRef(function (e, t) {
      ...
      let _,
        ...
        F =
          null != O &&
          (O === E || (!l && O.startsWith(E) && '/' === O.charAt(E.length))),
            ...
            onSubmit: o
              ...
              : (e) => {
                  ...
                  let t = e.nativeEvent.submitter,
                    o =
                      (null == t ? void 0 : t.getAttribute('formmethod')) || f;
                  g(t || e.currentTarget, {
                    fetcherKey: n,
                    method: o,
                    navigate: r,
  ...
  function J(e) {
    let { getKey: t, storageKey: n } = void 0 === e ? {} : e,
      ...
      { restoreScrollPosition: u, preventScrollReset: c } = H(
        M.UseScrollRestoration,
      ),
        ...
        i.useLayoutEffect(() => {
          let e =
            ...
            n =
              null == a
                ? void 0
                : a.enableScrollRestoration(Y, () => window.scrollY, e);
          return () => n && n();
        }, [a, l, t]),
        i.useLayoutEffect(() => {
          if (!1 !== u)
  ...
  function G(e, t) {
    ...
    let s =
      ...
      c =
        o.stripBasename(n.nextLocation.pathname, a) || n.nextLocation.pathname;
    return (
  ...
  (Object.defineProperty(e, 'AbortedDeferredError', {
    ...
    (e.BrowserRouter = function (e) {
      ...
      return (
        ...
        i.useEffect(() => r.UNSAFE_logV6DeprecationWarnings(a), [a]),
    ...
    (e.RouterProvider = function (e) {
      ...
      let S = i.useMemo(
        ...
        N = n.basename || '/',
        _ = i.useMemo(
          () => ({ router: n, navigator: S, static: !1, basename: N }),
          [n, S, N],
        ),
        j = i.useMemo(
      ...
      return (
        i.useEffect(
          () => r.UNSAFE_logV6DeprecationWarnings(o, n.future),
          [o, n.future],
        ),
        i.createElement(
          i.Fragment,
    ...
    (e.unstable_HistoryRouter = function (e) {
      ...
      return (
        ...
        i.useEffect(() => r.UNSAFE_logV6DeprecationWarnings(o), [o]),
        i.createElement(r.Router, {
          basename: t,
          children: n,
          location: u.location,
    ...
    (e.useFetcher = function (e) {
      ...
      let v = i.useCallback(
        ...
        w = c.get(m);
      return i.useMemo(
        () => s({ Form: g, submit: b, load: v }, y, { data: w }),
        [g, b, v, y, w],
      );
    }),
