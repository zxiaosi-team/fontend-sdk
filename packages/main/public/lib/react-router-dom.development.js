...
(function (global, factory) {
  ...
  function deserializeErrors(errors) {
    ...
    for (let [key, val] of entries) {
      ...
      if (val && val.__type === 'RouteErrorResponse') {
        serialized[key] = new router.UNSAFE_ErrorResponseImpl(
          val.status,
          val.statusText,
          val.data,
          val.internal === true,
  ...
  const FetchersContext = /*#__PURE__*/ React__namespace.createContext(
    new Map(),
  );
  {
  ...
  */
  ...
  function RouterProvider(_ref) {
    ...
    let optInStartTransition = React__namespace.useCallback(
      (cb) => {
    ...
    React__namespace.useEffect(() => {
      if (renderDfd && pendingState && router$1.window) {
        ...
        let transition = router$1.window.document.startViewTransition(
          async () => {
            optInStartTransition(() => setStateImpl(newState));
            await renderPromise;
          },
    ...
    React__namespace.useEffect(
      () =>
        reactRouter.UNSAFE_logV6DeprecationWarnings(future, router$1.future),
    ...
    return /*#__PURE__*/ React__namespace.createElement(
      ...
      /*#__PURE__*/ React__namespace.createElement(
        reactRouter.UNSAFE_DataRouterContext.Provider,
        {
          value: dataRouterContext,
        },
        /*#__PURE__*/ React__namespace.createElement(
          reactRouter.UNSAFE_DataRouterStateContext.Provider,
          {
            value: state,
          },
          /*#__PURE__*/ React__namespace.createElement(
  ...
  function BrowserRouter(_ref4) {
    ...
    React__namespace.useEffect(
      () => reactRouter.UNSAFE_logV6DeprecationWarnings(future),
      [future],
    );
   ...
   */
  const Link = /*#__PURE__*/ React__namespace.forwardRef(
    function LinkWithRef(_ref7, ref) {
      let {
          onClick,
          relative,
          reloadDocument,
      ...
      let { basename } = React__namespace.useContext(
        reactRouter.UNSAFE_NavigationContext,
      );
  ...
  const NavLink = /*#__PURE__*/ React__namespace.forwardRef(
    function NavLinkWithRef(_ref8, ref) {
      ...
      let routerState = React__namespace.useContext(
        reactRouter.UNSAFE_DataRouterStateContext,
      );
      let { navigator, basename } = React__namespace.useContext(
        reactRouter.UNSAFE_NavigationContext,
      );
      let isTransitioning =
        routerState != null &&
      ...
      if (nextLocationPathname && basename) {
        nextLocationPathname =
          router.stripBasename(nextLocationPathname, basename) ||
          nextLocationPathname;
      }
  ...
  function useDataRouterState(hookName) {
    let state = React__namespace.useContext(
      reactRouter.UNSAFE_DataRouterStateContext,
    );
    !state
      ? router.UNSAFE_invariant(false, getDataRouterConsoleError(hookName))
        ...
        if (shouldProcessLinkClick(event, target)) {
          ...
          let replace =
            replaceProp !== undefined
              ? replaceProp
              : reactRouter.createPath(location) ===
                reactRouter.createPath(path);
          navigate(to, {
            replace,
            state,
            preventScrollReset,
  ...
  function useSearchParams(defaultInit) {
    ...
    let defaultSearchParamsRef = React__namespace.useRef(
    ...
    let navigate = reactRouter.useNavigate();
    let setSearchParams = React__namespace.useCallback(
  ...
  function useFormAction(action, _temp2) {
    ...
    let routeContext = React__namespace.useContext(
      reactRouter.UNSAFE_RouteContext,
    );
    !routeContext
  ...
  function useFetcher(_temp3) {
    ...
    let { router: router$1 } = useDataRouterContext(DataRouterHook.UseFetcher);
    ...
    let [fetcherKey, setFetcherKey] = React__namespace.useState(
      key || defaultKey,
    );
    ...
    // Fetcher additions
    let load = React__namespace.useCallback(
      (href, opts) => {
        !routeId
          ? router.UNSAFE_invariant(
              false,
    ...
    let submit = React__namespace.useCallback(
      (target, opts) => {
        submitImpl(
          target,
          _extends({}, opts, {
    ...
    let FetcherForm = React__namespace.useMemo(() => {
      let FetcherForm = /*#__PURE__*/ React__namespace.forwardRef(
        (props, ref) => {
          return /*#__PURE__*/ React__namespace.createElement(
            Form,
            _extends({}, props, {
  ...
  function useScrollRestoration(_temp4) {
    ...
    let { router: router$1 } = useDataRouterContext(
      DataRouterHook.UseScrollRestoration,
    );
    ...
    if (typeof document !== 'undefined') {
      ...
      React__namespace.useLayoutEffect(() => {
          ...
          getKey && basename !== '/'
            ? (location, matches) =>
                getKey(
                  ...
                  _extends({}, location, {
                    pathname:
                      router.stripBasename(location.pathname, basename) ||
                      location.pathname,
                  }),
                  matches,
                )
        ...
        let disableScrollRestoration =
          router$1 == null
            ? void 0
            : router$1.enableScrollRestoration(
  ...
  function useViewTransitionState(to, opts) {
    ...
    let currentPath =
      router.stripBasename(vtContext.currentLocation.pathname, basename) ||
      vtContext.currentLocation.pathname;
    let nextPath =
      router.stripBasename(vtContext.nextLocation.pathname, basename) ||
    ...
    return (
      router.matchPath(path.pathname, nextPath) != null ||
      router.matchPath(path.pathname, currentPath) != null
    );
  }
