...
!(function (e, t) {
    ...
    return e
              ...
              function (n, a) {
                (void 0 === a && (a = {}),
                  r.current &&
                    ('number' == typeof n
                      ? e.navigate(n)
                      : e.navigate(n, o({ fromRouteId: t }, a))));
              },
              [e, t],
            )
          );
      ...
      : (function () {
          ...
          let e = a.useContext(i),
            ...
            { pathname: l } = v(),
            c = JSON.stringify(
              r.UNSAFE_getResolveToMatches(u, n.v7_relativeSplatPath),
            ),
            p = a.useRef(!1);
          return (
            m(() => {
            ...
            a.useCallback(
              function (n, a) {
                ...
                let i = r.resolveTo(n, JSON.parse(c), l, 'path' === a.relative);
                (null == e &&
                  '/' !== t &&
                  (i.pathname =
                    '/' === i.pathname ? t : r.joinPaths([t, i.pathname])),
                  (a.replace ? o.replace : o.push)(i, a.state, a));
              },
              [t, o, c, l, e],
            )
          );
  ...
  function H(e) {
    ...
    let {
      ...
      R = a.useMemo(() => {
        let e = r.stripBasename(h, v);
        return null == e
          ? null
          : {
              location: { pathname: e, search: E, hash: g, state: y, key: b },
              navigationType: u,
            };
      }, [v, h, E, g, y, b, u]);
    return null == R
  ...
  class J extends a.Component {
    ...
    render() {
      ...
      if (n instanceof Promise)
        if (this.state.error) {
          ...
          n._tracked
            ? ((o = n),
              (i =
                '_error' in o ? w.error : '_data' in o ? w.success : w.pending))
            : ((i = w.pending),
      ...
      if (i === w.error && o._error instanceof r.AbortedDeferredError) throw z;
      if (i === w.error && !t) throw o._error;
      if (i === w.error)
  ...
  (Object.defineProperty(e, 'AbortedDeferredError', {
    ...
    (e.Navigate = function (e) {
      ...
      return (
        a.useEffect(
          () => m(JSON.parse(g), { replace: n, state: o, relative: i }),
          [m, g, i, n, o],
        ),
        null
      );
      ...
      let { router: t, basename: n } = O(U.UseBlocker),
        ...
        s = a.useCallback(
          (t) => {
            ...
            return e({
              currentLocation: o({}, a, {
                pathname: r.stripBasename(a.pathname, n) || a.pathname,
              }),
              nextLocation: o({}, i, {
                pathname: r.stripBasename(i.pathname, n) || i.pathname,
              }),
              historyAction: u,
            });
          },
